...
import { getCards } from "./localStorage.js";
...
function makeIDCard(data) {
    const holder = new Human(data.holder.firstName, data.holder.lastName, data.holder.birthDate, data.holder.TAXID);
    return new IDCard(data.number, holder, data.photoDataURL);
}
//TODO / tweak
function saveIDCard(card) {
